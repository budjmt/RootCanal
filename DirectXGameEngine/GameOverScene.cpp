...
GameOverScene::GameOverScene( Camera** camera ) : Scene()
{
    _camera = camera;
    ...
    gameOverState = new GameOverState( this, _vertexShader, _pixelShader );
    StateManager::getInstance().gameState( gameOverState );
}

GameOverScene::~GameOverScene()
{
    if( gameOverState ) { delete gameOverState; gameOverState = nullptr; }
