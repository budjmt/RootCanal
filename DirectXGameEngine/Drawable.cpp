...
void Drawable::draw(Transform* transform, ID3D11DeviceContext* deviceContext) { Transform t = transform->getComputed(); draw(t.position(), t.scale(), t.rotAxis(), t.rotAngle(), deviceContext); }
